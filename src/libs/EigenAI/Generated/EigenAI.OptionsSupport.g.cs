...
namespace EigenAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::EigenAI.AutoSDKRetryOptions Retry { get; set; } = new global::EigenAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::EigenAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::EigenAI.IAutoSDKHook>();
        ...
        public global::EigenAI.AutoSDKClientOptions AddHook(
            global::EigenAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::EigenAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::EigenAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::EigenAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::EigenAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::EigenAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::EigenAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::EigenAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::EigenAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::EigenAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::EigenAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::EigenAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::EigenAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::EigenAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::EigenAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::EigenAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::EigenAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::EigenAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::EigenAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::EigenAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::EigenAI.AutoSDKClientOptions clientOptions,
            global::EigenAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::EigenAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::EigenAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::EigenAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::EigenAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::EigenAI.IAutoSDKHook, global::EigenAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::EigenAI.AutoSDKHookContext context)
        {
