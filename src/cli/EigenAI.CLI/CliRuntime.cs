...
namespace EigenAI.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "EigenAI.CLI";
    private const string UserSecretApiKeyName = "EIGENAI_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"EIGENAI_API_KEY"];
    private const string CredentialFileDirectoryName = ".eigen-ai";

    public static async global::System.Threading.Tasks.Task<global::EigenAI.EigenAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::EigenAI.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::EigenAI.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::EigenAI.EigenAIClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::EigenAI.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::EigenAI.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::EigenAI.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::EigenAI.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("EIGENAI_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::EigenAI.ApiException exception)
    {
        var builder = new StringBuilder();
