...
internal static class CliRuntime
{
    ...
    public static async Task<global::EigenAI.EigenAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::EigenAI.ApiException exception)
    {
        var builder = new StringBuilder();
